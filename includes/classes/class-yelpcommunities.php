 ...
 * Summary
 *
 * Main Class for Yelp Communities that contains the 2 shortcodes.
 *
...
class YelpCommunities {
	...
	public function yc_style() {
		$css  = WP_PLUGIN_URL . '/yelp-communities/includes/css/style.css';
		$form = WP_PLUGIN_URL . '/yelp-communities/includes/css/form.css';
	...
	public function yc_results( $data ) {
		...
		foreach ( $data['businesses'] as $location ) {
				...
				switch ( $rating ) {
					case 0:
						$stars = WP_PLUGIN_URL . '/yelp-communities/includes/images/regular_0.png';
						break;
					case 1:
						$stars = WP_PLUGIN_URL . '/yelp-communities/includes/images/regular_1.png';
						break;
					case 1.5:
						$stars = WP_PLUGIN_URL . '/yelp-communities/includes/images/regular_1_half.png';
						break;
					case 2:
						$stars = WP_PLUGIN_URL . '/yelp-communities/includes/images/regular_2.png';
						break;
					case 2.5:
						$stars = WP_PLUGIN_URL . '/yelp-communities/includes/images/regular_2_half.png';
						break;
					case 3:
						$stars = WP_PLUGIN_URL . '/yelp-communities/includes/images/regular_3.png';
						break;
					case 3.5:
						$stars = WP_PLUGIN_URL . '/yelp-communities/includes/images/regular_3_half.png';
						break;
					case 4:
						$stars = WP_PLUGIN_URL . '/yelp-communities/includes/images/regular_4.png';
						break;
					case 4.5:
						$stars = WP_PLUGIN_URL . '/yelp-communities/includes/images/regular_4_half.png';
						break;
					case 5:
						$stars = WP_PLUGIN_URL . '/yelp-communities/includes/images/regular_5.png';
						break;
				}
				...
				$html .= '<a class="yelp-branding" href="' . $url . '" target="_blank"><img src="' . WP_PLUGIN_URL . '/yelp-communities/includes/images/yelp.png" alt="Powered by Yelp"></a>';
				$html .= '</p>';
	...
	public function yc_my_community() {
		if ( check_admin_referer( 'yc_form_nonce' ) ) {
